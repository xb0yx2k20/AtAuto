...
if __name__ == '__main__':
    with app.app_context():
        ...
        # create car
        car1 = Car(Mark='Toyota', Model='Camry', Year=2020, Engine = '3.5',hp = 280, GearBox = 'at')
        car2 = Car(Mark='Kia', Model='Optima', Year=2018, Engine = '1.5', hp = 150, GearBox = 'at')
        car3 = Car(Mark='Dodge', Model='Ram TRX', Year=2023, Engine = '6.2', hp = 702, GearBox = 'at')
